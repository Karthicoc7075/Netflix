      ...
      <div>
        ...
        <div className='header' >
          ...
          <div className='language__container'>
            <select className='language__picker'  >
          ...
          <div>
            <a href='/login' className={'header__authBtn'} >Sign In</a>
          </div>
        </div>
      </div>
...
Joining Netflix is easy.
            ...
            <h6>Enter your password and you'll be watching in no time.</h6>
            <h5>Email<br/>
             {email}</h5> 
            <div className='signIn_form ' >
                <input className={password ? "required__error" :null} placeholder='Enter your Password' value={password } onChange={(e)=>setPassword(e.target.value)} />
                {passwordRequired ? <p>Password required</p> : null}
            </div>
<a href='/forget' className='signIn__forget' >Forget password ?</a>
            <button>
                Next
            </button>
