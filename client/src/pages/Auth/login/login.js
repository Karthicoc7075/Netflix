      ...
      <div>
        ...
        <div className='login' >
          ...
          <div className='login__form' >
            <form className='main__form' onSubmit={submitHandler} >
                <h2>Sign In</h2>
                <div className='form__group' >
              <input type={'text'} value={email} onChange={(e)=>setEmail(e.target.value)} placeholder='Email '/>
             {emailRequired ?   <p className='error'>Please enter a valid email address </p>:null}
              </div>
               <div className='form__group' >
               <input type={'text'}  value={password} onChange={(e)=>setPassword(e.target.value)} placeholder='Password' />   
              {passwordRequired ?  <p className='error'>Your password must contai  n between 8 and 60 characters.</p>:null}
               </div>
