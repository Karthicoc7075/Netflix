      ...
      <div className="regform__wrapper">
        <form className="regform" onSubmit={submitHandler}>
          ...
          <div className="regform__group">
            <input
              type={"text"}
              className={usernameRequired ? "required__error" : null}
              placeholder="Username"
              value={username}
              onChange={(e) => setUsername(e.target.value)}
            />
            {usernameRequired ? <p>Username required</p> : null}
          </div>
          <div className="regform__group">
            <input
              type={"text"}
              className={emailRequired ? "required__error" : null}
              placeholder="Email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
            {emailRequired ? <p>Email required</p> : null}
          </div>
          <div className="regform__group">
            <input
              type={"password"}
              ...
              className={passwordRequired ? "required__error" : null}
